...
# A value is never returned. Since Schme uses applicative-order
# evaluation, all the arguments of "new-if" need to be evaluated
# first. Since "(improve guess x)" is an argument and a recursion,
